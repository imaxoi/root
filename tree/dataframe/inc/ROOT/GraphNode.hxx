...
\brief Class used to create the operation graph to be printed in the dot representation
 ...
 This represent a single of the overall graph. Each node maps the real RNode keeping just
...
private:
   ...
   std::vector<std::string> fDefinedColumns; ///< Columns define up to this node. Useful to sport Defines
